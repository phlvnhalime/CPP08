...
/*   Updated: 2025/11/04 22:00:40 by hpehliva         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    MutantStack<int>::iterator it_accessible = mstack.begin();
    for(size_t i = 0; i < size; i++)
    {
        std::cout << "Index: [" << i << "] = " << it_accessible[static_cast<int>(i)] << std::endl;
    }
